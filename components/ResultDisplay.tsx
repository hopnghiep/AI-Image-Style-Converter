...
const ResultDisplay: React.FC<ResultDisplayProps> = ({ 
  ...
  const renderContent = () => {
    // Luôn ưu tiên hiển thị Batch Gallery nếu đang ở Batch Mode HOẶC đang xử lý hàng loạt HOẶC có kết quả hàng loạt trước đó
    if (isBatchMode || isBatchProcessing || batchResults.length > 0) {
        return (
